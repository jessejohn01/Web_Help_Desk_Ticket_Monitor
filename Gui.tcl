...
proc vTclWindow.top37 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -menu "$top.m50" -background {#d9d9d9} 
    wm focusmodel $top passive
    wm geometry $top 375x381+749+289
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_3_0.ent44 \
        -in $site_3_0 -x 180 -y 100 -width 124 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent45 \
        -in $site_3_0 -x 180 -y 140 -width 124 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab48 \
        -in $site_3_0 -x 60 -y 90 -width 74 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab49 \
        -in $site_3_0 -x 60 -y 130 -width 74 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    button $top.but43 \
    ...
    ###################
    place $top.fra42 \
        -in $top -x 10 -y 10 -width 355 -relwidth 0 -height 285 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but43 \
        -in $top -x 130 -y 320 -width 107 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
